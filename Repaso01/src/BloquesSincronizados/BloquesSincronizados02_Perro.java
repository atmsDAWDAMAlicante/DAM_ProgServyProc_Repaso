...
public class BloquesSincronizados02_Perro {
    public static void main(String[] args) {
        ...
        *
        ...
        HiloIngreso2 hi = new HiloIngreso2(c, p);
        HiloReintegro2 hr = new HiloReintegro2(c, p);
...
class HiloIngreso2 implements Runnable {
    private Cuenta2 cuenta;
    private Perro perro;
    public HiloIngreso2(Cuenta2 cuenta, Perro perro) {
        this.cuenta = cuenta;
        this.perro = perro;
    }
...
class HiloReintegro2 implements Runnable {
    private Cuenta2 cuenta;
    private Perro perro;

    public HiloReintegro2(Cuenta2 cuenta, Perro perro) {
        this.cuenta = cuenta;
        this.perro = perro;
    }
...
class Perro{
// Esta clase funciona como monitor
}
